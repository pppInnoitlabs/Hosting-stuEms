...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $pdo->prepare("SELECT * FROM teachers WHERE teacher_id = :student_id OR email = :email LIMIT 1");
            ...
            if ($user) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    header("Location: teacherDashboard.php"); // Redirect to dashboard page
                    exit();
                } else {
...
<body>
  <div class="container mt-5">
    ...
    <form action="teacherLogin.php" method="POST">
      ...
      <div class="mb-3">
        <label for="identifier" class="form-label">Teacher ID or Email</label>
      ...
      <a href="teacherRegister.php" class="btn btn-success ms-2">Create New Account</a>
