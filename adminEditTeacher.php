...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            echo "<div class='alert alert-success'>Teacher details updated successfully!</div>";
        } catch (PDOException $e) {
            echo "<div class='alert alert-danger'>Error: " . $e->getMessage() . "</div>";
        }
    } else {
...
<body>
  <div class="container mt-5">
    ...
    <form action="adminEditTeacher.php?id=<?php echo $id; ?>" method="POST">
      <!-- Name Field -->
      <div class="mb-3">
      ...
      <input type="hidden" name="student_id" value="<?php echo htmlspecialchars($studentData['teacher_id']); ?>">
